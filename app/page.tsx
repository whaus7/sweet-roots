  ...
  return (
    <div>
      ...
      <HeroBanner
        ...
        subtitle="Learn about the different ways soil can be tested. Western agriculture has been fixated on the chemical composition, but there's much more!"
      ...
      <div className="flex p-5 justify-center w-full">
        <div id="dashboard" className="w-full max-w-[1100]">
          ...
          <Tile
            type="plfa"
            title="Polylipids Fatty Acid Profile"
            tileType="plfa"
          >
            <PLFADonutChart
              bacteria={45}
